...
export default function NewAIProjectPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push("/executive/projects/new-ai/preview")
    } catch (err) {
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-slate-900 dark:text-white">Assign Manager</p>
                  <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">
                    Choose a manager and review the plan before creating
                  </p>
                </div>
              </div>
            </div>
